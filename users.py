        ...
        if os.path.exists(file_path):
            with pd.ExcelFile(file_path) as xls:
                if 'Users' in xls.sheet_names:
                    ...
                    # Ensure user_id is in string format (since it is a UUID)
...
# Wywietlanie danych uzytkownika po UUID
# user_id = input("Podaj UUID") # Replace with a valid UUID
...
# Wywietlanie danych uzytkownika po login
#
